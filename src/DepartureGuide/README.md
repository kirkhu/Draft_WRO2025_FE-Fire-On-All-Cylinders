...
- ### Parking program-出發計劃
    ### 中文:
    - 車輛啟動時，主控系統 (Jetson Orin Nano) 透過攝影機執行影像識別，首先判斷車輛的預設行駛方向，隨後識別並鎖定目標賽道路線的顏色。逆時針路徑偵測到綠柱時車輛向左轉90度，往前進後，車輛會向右轉90度，後退至預定位置。偵測到紅柱時：車輛前進，車輛向左轉90度，往前進後，車輛會後退向右轉90度，後退至預定位置。未偵測到任何柱子時：執行前進向左轉90度，往前進後，後退向左轉90度，後退至預定位置。
