...
### 中文:
  每個電子元件接需要特定的工作電壓才能正常運作，配置如下：
   - 3S 鋰聚合物電池提供 12.6V 電壓，供電給降壓模組、Nvidia Jetson Orin Nano 及 L293D 馬達驅動晶片，用於驅動 12V 直流馬達。
   - 5A 恆壓恆流降壓電源模組將 12.6V 電壓降至 5V，為需要 5V 工作電壓的元件供電，包括 Raspberry Pi Pico W、L293D 雙 H 橋直流馬達驅動 IC、超聲波距離感測模組、紅外線反射模組及 MG90S 前輪伺服馬達。
   - Nvidia Jetson Orin Nano 控制板提供 3.3V 電壓給 BNO055 陀螺儀方向感測器、攝影機模組。
